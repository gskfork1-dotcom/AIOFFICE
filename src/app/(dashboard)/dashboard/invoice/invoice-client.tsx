...
import { createInvoiceAction, getCompanyProfile, saveCompanyProfile } from "@/lib/actions/documents"
...
export default function InvoiceClient() {
  ...
  async function handlePdfExport() {
    ...
    try {
      await exportHtmlToPdf(html, "Invoice")
      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="space-y-6">
            ...
            <CardContent className="space-y-3">
              ...
              <div className="border-t pt-3 mt-3 flex justify-end">
                <div className="w-72 space-y-1 text-sm">
                  ...
                  <div className="flex justify-between"><span className="text-muted-foreground">PPN (11%)</span><span>{formatRupiah(ppn)}</span></div>
                  <div className="flex justify-between font-bold text-base border-t pt-1"><span>Grand Total</span><span className="text-blue-600">{formatRupiah(grandTotal)}</span></div>
                </div>
              </div>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent>
              <Textarea value={notes} onChange={(e) => setNotes(e.target.value)} placeholder="Catatan tambahan untuk invoice (opsional)" rows={3} />
            </CardContent>
          </Card>
